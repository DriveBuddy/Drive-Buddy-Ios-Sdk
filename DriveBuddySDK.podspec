#
#  Be sure to run `pod spec lint DriveBuddySDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "DriveBuddySDK"
  s.version      = "0.0.1"
  s.summary      = "A short description of DriveBuddyHelper."
  ...
  s.homepage     = "http://www.drivebuddyapp.com"
  ...
  s.license      = "All Rights Reserved to Drive Buddy"
 ...
 #s.vendored_frameworks = 'DerivedData/Build/Products/Release-iphoneos/DriveBuddySDK.framework'
 #s.vendored_frameworks = 'DerivedData/Build/Products/Release-iphonesimulator/DriveBuddySDK.framework'
  ...
  s.dependency "DriveBuddyCore", "~> 0.2.5" #"#:path => "../drive-buddy-sdk/"
end
